...
namespace PharmacyAdjudicator.Library.Core.Rules
{
    ...
    public class EditableChild1 : BusinessBase<EditableChild1>
    {
        ...
        internal static EditableChild1 NewEditableChild()
        {
            return DataPortal.CreateChild<EditableChild1>();
        }

        internal static EditableChild1 GetEditableChild(object childData)
        {
            return DataPortal.FetchChild<EditableChild1>(childData);
        }
